(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Observable'), require('rxjs/add/observable/from'), require('rxjs/add/operator/mergeMap'), require('rxjs/add/operator/reduce'), require('rxjs/add/operator/groupBy'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/Observable', 'rxjs/add/observable/from', 'rxjs/add/operator/mergeMap', 'rxjs/add/operator/reduce', 'rxjs/add/operator/groupBy', '@angular/common'], factory) :
	(factory((global['ngx-easy-table'] = {}),global.ng.core,global.Rx,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.ng.common));
}(this, (function (exports,core,Observable,from,mergeMap,reduce,groupBy,common) { 'use strict';
